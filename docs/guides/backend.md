...
**Neu in VelinScript 3.1 / Fokus 3.5.0:** Der **SystemGenerator** erstellt stabile REST/Axum-Grundgerüste. Weitere Systemkomponenten wie Auth, Datenbank und AI werden je nach Bereich als Experimental geführt.
