...
**Version:** 3.0.1 / 3.1.0  
**Status:** Architektur / Experimental — nicht Teil des stabilen 3.5.0-Produktumfangs (kein GA-Claim für echte AI-Sandbox-Ausführung).

---

## Übersicht

VelinScript enthält optionale KI-basierte Compiler-Passes. Für den Stable-Pfad 3.5.0 (Rust/Axum HTTP/`@Auth`) sind sie nicht erforderlich.
