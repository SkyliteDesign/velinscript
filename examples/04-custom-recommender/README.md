# 04-custom-recommender

**Advanced Example - Production-Nähe**

> ⚠️ **Wichtig**: Dies ist ein fortgeschrittenes Beispiel. Kein Einstieg für Anfänger.
> 
> **Neu hier?** → Starte mit `01-hello-api`  
...
```bash
cd examples/04-custom-recommender
