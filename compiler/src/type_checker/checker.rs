...
impl TypeChecker {
    pub fn new() -> Self {
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![crate::type_checker::environment::ParameterInfo {
        ...
        env.define_type(
            "Validator".to_string(),
            Type::Named("Validator".to_string()),
        );
        env.define_type(
            "AuthService".to_string(),
            Type::Named("AuthService".to_string()),
        );
        env.define_type("Logger".to_string(), Type::Named("Logger".to_string()));
        env.define_type(
            "VelinLogger".to_string(),
            Type::Named("VelinLogger".to_string()),
        );
        env.define_type(
            "MetricsCollector".to_string(),
            Type::Named("MetricsCollector".to_string()),
        );
        env.define_type(
            "PerformanceMonitor".to_string(),
            Type::Named("PerformanceMonitor".to_string()),
        );
        env.define_type(
            "LLMClient".to_string(),
            Type::Named("LLMClient".to_string()),
        );
        env.define_type(
            "ModelLoader".to_string(),
            Type::Named("ModelLoader".to_string()),
        );
        env.define_type(
            "TrainingService".to_string(),
            Type::Named("TrainingService".to_string()),
        );
        env.define_type(
        ...
        env.define_function(
            "MetricsCollector.new".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "PerformanceMonitor.new".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "datetime.formatISO8601".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "alerting.create_rule".to_string(),
            FunctionSignature {
        ...
        env.define_type(
            "StringStdlib".to_string(),
            Type::Named("StringStdlib".to_string()),
        );
        env.define_type(
            "MathStdlib".to_string(),
            Type::Named("MathStdlib".to_string()),
        );
        env.define_type(
            "DateStdlib".to_string(),
            Type::Named("DateStdlib".to_string()),
        );
        env.define_type("FsStdlib".to_string(), Type::Named("FsStdlib".to_string()));
        env.define_type(
            "LLMStdlib".to_string(),
            Type::Named("LLMStdlib".to_string()),
        );
        env.define_type(
            "EmbeddingStdlib".to_string(),
            Type::Named("EmbeddingStdlib".to_string()),
        );
        env.define_type(
            "AgentStdlib".to_string(),
            Type::Named("AgentStdlib".to_string()),
        );
        env.define_type(
            "ProcessStdlib".to_string(),
            Type::Named("ProcessStdlib".to_string()),
        );
        env.define_type(
            "SandboxStdlib".to_string(),
            Type::Named("SandboxStdlib".to_string()),
        );
        env.define_type(
            "WebSocketStdlib".to_string(),
            Type::Named("WebSocketStdlib".to_string()),
        );
        env.define_type(
            "UtilsStdlib".to_string(),
            Type::Named("UtilsStdlib".to_string()),
        );
        env.define_type(
            "LogStdlib".to_string(),
            Type::Named("LogStdlib".to_string()),
        );
        env.define_type(
            "PathStdlib".to_string(),
            Type::Named("PathStdlib".to_string()),
        );
        env.define_type(
            "UrlStdlib".to_string(),
            Type::Named("UrlStdlib".to_string()),
        );
        env.define_type(
            "StreamStdlib".to_string(),
            Type::Named("StreamStdlib".to_string()),
        );
        env.define_type(
            "RedisStdlib".to_string(),
            Type::Named("RedisStdlib".to_string()),
        );
        env.define_type(
            "TracingStdlib".to_string(),
            Type::Named("TracingStdlib".to_string()),
        );

        env.define_type("Agent".to_string(), Type::Named("Agent".to_string()));
        env.define_type(
            "WebSocket".to_string(),
            Type::Named("WebSocket".to_string()),
        );
        env.define_type(
            "SearchResult".to_string(),
            Type::Named("SearchResult".to_string()),
        );
        env.define_type(
            "RedisClient".to_string(),
            Type::Named("RedisClient".to_string()),
        );
        env.define_type("Span".to_string(), Type::Named("Span".to_string()));

        // --- Yaml Module ---
        env.define_type(
            "YamlStdlib".to_string(),
            Type::Named("YamlStdlib".to_string()),
        );
        env.define_variable("yaml".to_string(), Type::Named("YamlStdlib".to_string()));
        env.define_function(
            "yaml.parse".to_string(),
            FunctionSignature {
                name: "yaml.parse".to_string(),
                params: vec![crate::type_checker::environment::ParameterInfo {
                    name: "yaml_string".to_string(),
                    param_type: Type::String,
                }],
                return_type: Some(Type::Named("any".to_string())),
            },
        ...
        env.define_type(
            "EnvStdlib".to_string(),
            Type::Named("EnvStdlib".to_string()),
        );
        ...
        // --- Fixtures Module ---
        env.define_type(
            "FixturesStdlib".to_string(),
            Type::Named("FixturesStdlib".to_string()),
        );
        env.define_variable(
            "fixtures".to_string(),
            Type::Named("FixturesStdlib".to_string()),
        ...
        env.define_function(
            "fixtures.create_many".to_string(),
            FunctionSignature {
        ...
        // --- Mocks Module ---
        env.define_type(
            "MocksStdlib".to_string(),
            Type::Named("MocksStdlib".to_string()),
        );
        env.define_variable("mocks".to_string(), Type::Named("MocksStdlib".to_string()));
        env.define_function(
            "mocks.mock".to_string(),
            FunctionSignature {
        ...
        // --- Template Module ---
        env.define_type(
            "TemplateStdlib".to_string(),
            Type::Named("TemplateStdlib".to_string()),
        );
        env.define_variable(
            "template".to_string(),
            Type::Named("TemplateStdlib".to_string()),
        ...
        env.define_function(
            "template.render_file".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "template.partial".to_string(),
            FunctionSignature {
                name: "template.partial".to_string(),
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "partial_path".to_string(),
                        param_type: Type::String,
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "data".to_string(),
        ...
        env.define_type(
            "CsvStdlib".to_string(),
            Type::Named("CsvStdlib".to_string()),
        );
        ...
        // --- Encryption Module ---
        env.define_type(
            "EncryptionStdlib".to_string(),
            Type::Named("EncryptionStdlib".to_string()),
        );
        env.define_variable(
        ...
        env.define_function(
            "encryption.aes_encrypt".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encryption.aes_decrypt".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encryption.rsa_generate_keypair".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encryption.rsa_encrypt".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encryption.rsa_decrypt".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encryption.fernet_generate_key".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encryption.fernet_encrypt".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encryption.fernet_decrypt".to_string(),
            FunctionSignature {
        ...
        // --- EventBus Module ---
        env.define_type(
            "EventBusStdlib".to_string(),
            Type::Named("EventBusStdlib".to_string()),
        );
        env.define_variable(
            "event_bus".to_string(),
            Type::Named("EventBusStdlib".to_string()),
        ...
        env.define_function(
            "event_bus.unsubscribe".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "event_bus.get_history".to_string(),
            FunctionSignature {
        ...
        // --- MongoDB Module ---
        env.define_type(
            "MongoDbStdlib".to_string(),
            Type::Named("MongoDbStdlib".to_string()),
        );
        env.define_variable(
            "mongodb".to_string(),
            Type::Named("MongoDbStdlib".to_string()),
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                return_type: Some(Type::Result {
                    ok: Box::new(Type::List(Box::new(Type::Named("any".to_string())))),
                    err: Box::new(Type::String),
                }),
            },
        );
        env.define_function(
            "mongodb.find_one".to_string(),
            FunctionSignature {
                ...
                return_type: Some(Type::Result {
                    ok: Box::new(Type::Optional(Box::new(Type::Named("any".to_string())))),
                    err: Box::new(Type::String),
                }),
            },
        );
        env.define_function(
            "mongodb.update_one".to_string(),
            FunctionSignature {
            ...
            FunctionSignature {
                ...
                params: vec![
                    ...
                    crate::type_checker::environment::ParameterInfo {
                        ...
                        param_type: Type::List(Box::new(Type::Named("any".to_string()))),
                    },
                ],
                return_type: Some(Type::Result {
                    ok: Box::new(Type::List(Box::new(Type::Named("any".to_string())))),
        ...
        env.define_function(
            "mongodb.create_index".to_string(),
            FunctionSignature {
        ...
        // --- Queue Module ---
        env.define_type(
            "QueueStdlib".to_string(),
            Type::Named("QueueStdlib".to_string()),
        );
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![crate::type_checker::environment::ParameterInfo {
                    ...
                    param_type: Type::Optional(Box::new(Type::Number)),
                }],
                return_type: Some(Type::Named("any".to_string())),
            },
        );
        ...
        env.define_function(
            "queue.priority_create".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "queue.priority_enqueue".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "queue.bounded_create".to_string(),
            FunctionSignature {
        ...
        // --- Scheduler Module ---
        env.define_type(
            "SchedulerStdlib".to_string(),
            Type::Named("SchedulerStdlib".to_string()),
        );
        env.define_variable(
            "scheduler".to_string(),
            Type::Named("SchedulerStdlib".to_string()),
        ...
        env.define_function(
            "scheduler.schedule_interval".to_string(),
            FunctionSignature {
        ...
        // --- Smtp Module ---
        env.define_type(
            "SmtpStdlib".to_string(),
            Type::Named("SmtpStdlib".to_string()),
        );
        env.define_variable("smtp".to_string(), Type::Named("SmtpStdlib".to_string()));
        env.define_function(
            "smtp.connect".to_string(),
            FunctionSignature {
        ...
        // --- Workflow Module ---
        env.define_type(
            "WorkflowStdlib".to_string(),
            Type::Named("WorkflowStdlib".to_string()),
        );
        env.define_variable(
            "workflow".to_string(),
            Type::Named("WorkflowStdlib".to_string()),
        ...
        env.define_function(
            "workflow.execute_step".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "workflow.get_history".to_string(),
            FunctionSignature {
        ...
        // --- Encoding Module ---
        env.define_type(
            "EncodingStdlib".to_string(),
            Type::Named("EncodingStdlib".to_string()),
        );
        env.define_variable(
            "encoding".to_string(),
            Type::Named("EncodingStdlib".to_string()),
        ...
        env.define_function(
            "encoding.base64_encode".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encoding.base64_decode".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encoding.is_valid_utf8".to_string(),
            FunctionSignature {
                name: "encoding.is_valid_utf8".to_string(),
                params: vec![crate::type_checker::environment::ParameterInfo {
                    name: "bytes".to_string(),
                    param_type: Type::List(Box::new(Type::Number)),
                }],
                return_type: Some(Type::Boolean),
            },
        );
        env.define_function(
            "encoding.fix_utf8".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "tracing.set_attribute".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "url.parse_query".to_string(),
            FunctionSignature {
                name: "url.parse_query".to_string(),
                params: vec![crate::type_checker::environment::ParameterInfo {
                    name: "query_str".to_string(),
                    param_type: Type::String,
                }],
                return_type: Some(Type::Map {
                    key: Box::new(Type::String),
                    value: Box::new(Type::String),
                }),
            },
        ...
        // --- Audit Module ---
        env.define_type(
            "AuditStdlib".to_string(),
            Type::Named("AuditStdlib".to_string()),
        );
        ...
        env.define_type(
            "TestModuleStdlib".to_string(),
            Type::Named("TestModuleStdlib".to_string()),
        );
        env.define_variable(
        ...
        env.define_function(
            "test_module.validate_input".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "test_module.transform_format".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "date.format_relative".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "config.get_or_default".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "llm.extract_entities".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "embedding.cluster".to_string(),
            FunctionSignature {
                name: "embedding.cluster".to_string(),
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "list".to_string(),
                        param_type: Type::List(Box::new(Type::List(Box::new(Type::Number)))),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "k".to_string(),
                        param_type: Type::Number,
                ...
                return_type: Some(Type::Result {
                    ok: Box::new(Type::List(Box::new(Type::List(Box::new(Type::List(
                        Box::new(Type::Number),
                    )))))),
                    err: Box::new(Type::String),
                }),
        ...
        env.define_function(
            "encryption.generate_key".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encryption.store_key".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "encryption.retrieve_key".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "embedding.find_nearest".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "rollback.list_snapshots".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "rollback.delete_snapshot".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "rollback.auto_snapshot".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "http.set_timeout".to_string(),
            FunctionSignature {
                name: "http.set_timeout".to_string(),
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "client".to_string(),
                        param_type: Type::Named("HttpClient".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "ms".to_string(),
                        param_type: Type::Number,
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                return_type: Some(Type::Result {
                    ok: Box::new(Type::Named("WebSocket".to_string())),
                    err: Box::new(Type::String),
                }),
            },
        );
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "ws".to_string(),
                        param_type: Type::Named("WebSocket".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "message".to_string(),
                        param_type: Type::String,
        ...
        env.define_function(
            "websocket.is_connected".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            "websocket.on_message".to_string(),
            FunctionSignature {
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                return_type: Some(Type::List(Box::new(Type::Result {
                    ok: Box::new(Type::Named("any".to_string())),
                    err: Box::new(Type::String),
                }))),
            },
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![crate::type_checker::environment::ParameterInfo {
                    name: "url".to_string(),
                    param_type: Type::Named("Url".to_string()),
                }],
                return_type: Some(Type::String),
            },
        );
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "stream".to_string(),
                        param_type: Type::Named("Stream".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "mapper".to_string(),
                        param_type: Type::Named("fn".to_string()),
                    },
                ],
                return_type: Some(Type::Named("Stream".to_string())),
            },
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                return_type: Some(Type::Result {
                    ok: Box::new(Type::Named("RedisClient".to_string())),
                    err: Box::new(Type::String),
                }),
            },
        );
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "client".to_string(),
                        param_type: Type::Named("RedisClient".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "key".to_string(),
                        param_type: Type::String,
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "span".to_string(),
                        param_type: Type::Named("Span".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "key".to_string(),
                        param_type: Type::String,
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "queue".to_string(),
                        param_type: Type::Named("Queue".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "item".to_string(),
                        param_type: Type::Named("any".to_string()),
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                return_type: Some(Type::Result {
                    ok: Box::new(Type::Named("MongoClient".to_string())),
                    err: Box::new(Type::String),
                }),
            },
        );
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "client".to_string(),
                        param_type: Type::Named("MongoClient".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "name".to_string(),
                        param_type: Type::String,
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "db".to_string(),
                        param_type: Type::Named("Database".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "name".to_string(),
                        param_type: Type::String,
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "collection".to_string(),
                        param_type: Type::Named("Collection".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "doc".to_string(),
                        param_type: Type::Named("any".to_string()),
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                return_type: Some(Type::Result {
                    ok: Box::new(Type::Named("SmtpClient".to_string())),
                    err: Box::new(Type::String),
                }),
            },
        );
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "mailer".to_string(),
                        param_type: Type::Named("SmtpClient".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "email".to_string(),
                        param_type: Type::Named("any".to_string()),
        ...
        env.define_function(
            ...
            FunctionSignature {
                ...
                params: vec![
                    crate::type_checker::environment::ParameterInfo {
                        name: "bus".to_string(),
                        param_type: Type::Named("EventBus".to_string()),
                    },
                    crate::type_checker::environment::ParameterInfo {
                        name: "topic".to_string(),
                        param_type: Type::String,
        ...
        env.define_variable(
            "metrics".to_string(),
            Type::Named("MetricsStdlib".to_string()),
        );
        ...
        env.define_variable(
            "alerting".to_string(),
            Type::Named("AlertingStdlib".to_string()),
        );
    ...
    pub fn check_program(&mut self, program: &Program) -> Result<(), Vec<TypeError>> {
...

        {
            ...
            if let Ok(mut file) = std::fs::OpenOptions::new()
                .create(true)
                .append(true)
                .open("d:\\velinscript\\checker_debug.log")
            {
                            ...
                            if let Expression::Await { expr } = &let_stmt.value {
                                ...
                                if self.environment.has_variable(&let_stmt.name) {
                                    let current_type = self
                                        .environment
                                        .get_variable(&let_stmt.name)
                                        .unwrap_or(Type::Any);
                                    if matches!(current_type, Type::Any) {
                                        self.environment
                                            .define_variable(let_stmt.name.clone(), awaited_type);
                                    }
                                }
                            }
                        }
                        // For other desugared variables, try to infer from value if currently Any
                            ...
                            if value_type != Type::Void && value_type != Type::Any {
                                if self.environment.has_variable(&let_stmt.name) {
                                    ...
                                    if matches!(current_type, Type::Any) {
                                        self.environment
                                            .define_variable(let_stmt.name.clone(), value_type);
                                    }
                                }
                            }
                        }
            ...
            match item {
                ...
                Item::Function(f) => {
                    ...
                    let params: Vec<_> = f
                        .params
                        .iter()
                        .map(|p| crate::type_checker::environment::ParameterInfo {
                            name: p.name.clone(),
                        ...
                        if let Statement::Let(let_stmt) = &f.body.statements[0] {
                            ...
                            if let Some(ref var_type) = let_stmt.var_type {
                                ...
                                if !self.environment.has_variable(&var_name) {
                                    self.environment
                                        .define_variable(var_name.clone(), var_type.clone());
                                }
                            } else {
                                ...
                                if value_type == Type::Void {
                                    ...
                                    if !self.environment.has_variable(&var_name) {
                                        self.environment
                                            .define_variable(var_name.clone(), value_type.clone());
                                    }
                                }
                            }
                ...
                Item::Use(u) => {
                    ...
                    if let Some(module_env) = self.environment.get_module(&module_name) {
                        ...
                        for (name, struct_def) in &module_env.structs {
                            self.environment
                                .define_struct(name.clone(), struct_def.clone());
                        }
                        ...
                        for (name, func_sig) in &module_env.functions {
                            ...
                            self.environment
                                .define_function(name.clone(), func_sig.clone());
                        }
                        ...
                        if let Some(alias) = u.path.last() {
                            {
                                    ...
                                    .open("d:\\velinscript\\checker_debug.log")
                                {
                                    writeln!(
                                        file,
                                        "DEBUG: Defining module alias {} in current scope",
                                        alias
                                    )
                                    .ok();
                                }
                            ...
                            self.environment
                                .define_module(alias.clone(), module_env.clone());
                        }
                    } else {
                        {
                            use std::io::Write;
                                ...
                                .open("d:\\velinscript\\checker_debug.log")
                            {
                                writeln!(
                                    file,
                                    "DEBUG: Module {} NOT found in environment",
                                    module_name
                                )
                                .ok();
                            }
    ...
    fn validate_rate_limit_decorator(
        &mut self,
        decorator: &Decorator,
    ...
    fn check_impl(&mut self, impl_def: &Impl) -> Result<(), Vec<TypeError>> {
        ...
        if !impl_def.trait_name.is_empty() {
            if !self.environment.has_type(&impl_def.trait_name) {
                self.errors
                    .push(TypeError::undefined_type(&impl_def.trait_name));
            }
        }
                ...
                Statement::Let(let_stmt) => {
                    ...
                    if let Some(ref var_type) = let_stmt.var_type {
                        ...
                        if let_stmt.name.starts_with("__") && value_type == Type::Void {
                            ...
                            if !self.environment.has_variable(&let_stmt.name) {
                                self.environment
                                    .define_variable(let_stmt.name.clone(), Type::Any);
                            }
                        }
                        if value_type == Type::Void {
                                ...
                                if let Expression::Member { object, member } = callee.as_ref() {
                                    if member == "new" {
                                        if let Expression::Identifier(class_name) = object.as_ref()
                                        {
                                            ...
                                            if let Some(sig) =
                                                self.environment.get_function(&constructor_name)
                                            {
                                                // Use the constructor's return type
                                                let inferred_type =
                                                    sig.return_type.unwrap_or(Type::Void);
                            ...
                            if self.environment.has_variable(&let_stmt.name) {
                                ...
                                self.environment
                                    .define_variable(let_stmt.name.clone(), resolved_type);
                            }
                        }
                    }
                }
    ...
    fn resolve_generic_params(
        ...
        match target_type {
            ...
            Type::List(inner) => Type::List(Box::new(self.resolve_generic_params(
                inner,
                type_params,
                type_args,
            ))),
            ...
            Type::Optional(inner) => Type::Optional(Box::new(self.resolve_generic_params(
                inner,
                type_params,
                type_args,
            ))),
            ...
            Type::Generic { name, params } => Type::Generic {
                ...
                params: params
                    .iter()
                    .map(|p| self.resolve_generic_params(p, type_params, type_args))
                    .collect(),
            },
            _ => target_type.clone(),
        }
    ...
    fn check_expression(&mut self, expr: &Expression) -> Result<Type, Vec<TypeError>> {
        match expr {
            ...
            Expression::ListLiteral(elements) => self.check_list_literal(elements),
            ...
            Expression::Member { object, member } => {
                ...
                match obj_type {
                    ...
                    Type::List(ref item_type) => match member.as_str() {
                    ...
                    Type::Map { ref key, ref value } => match member.as_str() {
                        "length" | "size" | "len" => Ok(Type::Number),
                    ...
                    Type::Generic { name, params } => {
                        if name == "List" && params.len() == 1 {
                            ...
                            match member.as_str() {
                                ...
                                "find" | "contains" => {
                                    Ok(Type::Optional(Box::new(item_type.clone())))
                                }
                                "reduce" => Ok(item_type.clone()),
                                "sort" | "reverse" => Ok(Type::Void),
                                "chunk" | "slice" => Ok(Type::List(Box::new(item_type.clone()))),
                                ...
                                struct_def.fields.iter().find(|f| f.name == *member)
                            {
                                ...
                                return Ok(self.resolve_generic_params(
                                    field_type,
                    ...
                    Type::Void => {
                        self.errors.push(TypeError::new(
                            TypeErrorKind::InvalidMemberAccess,
                            format!(
                                "Type 'void' does not support member access (property '{}')",
                                member
                            ),
                        ));
                        Ok(Type::Void)
                    ...
                    Type::Named(ref class_name) => {
                        ...
                        if class_name.contains('.') {
                            ...
                            if parts.len() == 2 {
                                ...
                                eprintln!(
                                    "DEBUG: Looking up member '{}' on type '{}'",
                                    member, class_name
                                );
                                if let Some(module_env) = self.environment.get_module(mod_name) {
                                    ...
                                    eprintln!(
                                        "DEBUG: Module '{}' NOT found. Available modules: {:?}",
                                        mod_name,
                                        self.environment.modules.keys()
                                    );
                                }
                            }
                        }
                        ...
                        match class_name.as_str() {
                            ...
                            "Validator" => {
                                match member.as_str() {
                                    ...
                                    "errors" => Ok(Type::List(Box::new(Type::Named(
                                        "ValidationError".to_string(),
                                    )))),
                                    _ => Ok(Type::Void),
                                }
                            ...
                            "AuthService" => match member.as_str() {
                                ...
                                "verifyToken" => Ok(Type::Optional(Box::new(Type::Named(
                                    "UserClaims".to_string(),
                                )))),
                            ...
                            "Logger" | "VelinLogger" => {
                                match member.as_str() {
                                    ...
                                    "setLevel" | "addContext" | "removeContext"
                                    | "enableJsonFormat" | "enableRotation" => Ok(Type::Void),
                                    _ => Ok(Type::Void),
                                }
                            }
                            "DateTime" => {
                            ...
                            "MetricsCollector" => match member.as_str() {
                                ...
                                "getMetrics" => {
                                    Ok(Type::List(Box::new(Type::Named("Metric".to_string()))))
                                }
                                "getMetric" => {
                                    Ok(Type::Optional(Box::new(Type::Named("Metric".to_string()))))
                                }
            ...
            Expression::Index { object, index } => {
                ...
                match obj_type {
                    Type::List(ref item_type) => {
                        if index_type != Type::Number {
                            self.errors
                                .push(TypeError::type_mismatch("number", &index_type.to_string()));
                        }
            ...
            Expression::Lambda {
                ...
                let body_type = match body.as_ref() {
                    Expression::Block(block) => self.check_block(block, return_type.as_ref())?,
            ...
            Expression::Block(block) => Ok(self.check_block(block, None)?),
                    ...
                    "analyze" | "summarize" | "evaluate" | "sentiment" => {
                        if args.is_empty() {
                            self.errors.push(TypeError::new(
                                ...
                                format!(
                                    "@llm.{} requires at least 1 argument (text: string)",
                                    method
                                ),
                            ));
                        } else {
    ...
    fn check_binary_operation(
        ...
        if let Type::Named(name) = right_type {
            if name == "any" {
                return Ok(Type::Named("any".to_string()));
            }
        }
    ...
    fn check_type(&mut self, type_def: &Type) -> Result<(), Vec<TypeError>> {
        match type_def {
            Type::String | Type::Number | Type::Boolean | Type::Void | Type::Null | Type::Any => {
                Ok(())
            }
            Type::Named(name) => {
                ...
                if name == "List" || name == "Map" || name == "Result" {
                    ...
                    if name == "Result" && params.len() != 2 {
                        self.errors.push(TypeError::new(
                            ...
                            format!(
                                "Result requires exactly 2 type parameters, found {}",
                                params.len()
                            ),
                        ));
                        return Ok(());
    ...
    fn check_pattern(
        ...
        pattern: &Pattern,
        match_type: &Type,
    ) -> Result<Environment, Vec<TypeError>> {
        let parent_env = self.environment.clone();
        ...
        match pattern {
            ...
            Pattern::Range { start, end, .. } => {
                ...
                if !self.types_compatible(match_type, &Type::Number) {
                    self.errors
                        .push(TypeError::type_mismatch("number", &match_type.to_string()));
                }
            }
                ...
                if let Type::Tuple(types) = match_type {
                    if patterns.len() != types.len() {
                        self.errors.push(TypeError::new(
                            ...
                            format!(
                                "Tuple pattern length {} doesn't match tuple type length {}",
                                patterns.len(),
                                types.len()
                            ),
                        ));
                    ...
                    self.errors
                        .push(TypeError::type_mismatch("tuple", &match_type.to_string()));
                }
            }
            Pattern::Struct { name, fields } => {
                ...
                if let Type::Named(type_name) = match_type {
                    if name != type_name {
                        self.errors.push(TypeError::type_mismatch(type_name, name));
                    }
                } else if let Type::Generic { name: gen_name, .. } = match_type {
                    if name != gen_name {
                        self.errors.push(TypeError::type_mismatch(gen_name, name));
                    }
                }
                ...
                if let Some(struct_def) = self.environment.get_struct(&name) {
                    for (field_name, field_pattern) in fields {
                            ...
                            struct_def.fields.iter().find(|f| f.name == *field_name)
                        {
                            ...
                            let _field_env =
                                self.check_pattern(field_pattern, &field.field_type)?;
                ...
                if let Type::Named(type_name) = match_type {
                    ...
                    if let Some(enum_name) = name.split("::").next() {
                        if enum_name != type_name {
                            self.errors
                                .push(TypeError::type_mismatch(type_name, enum_name));
                        } else {
                                            ...
                                            .find(|v| v.name == variant_name)
                                        {
                                            if let Some(variant_data_types) = &variant.data {
                                                if data_patterns.len() != variant_data_types.len() {
                                                    self.errors.push(
                                                        TypeError::wrong_argument_count(
                                                    ...
                                                    for (pattern, data_type) in data_patterns
                                                        .iter()
                                                        .zip(variant_data_types.iter())
                                                    {
                                                        let _pattern_env =
                                                            self.check_pattern(pattern, data_type)?;
                                                        // Pattern bindings are already handled in check_pattern
                                                    }
                                                }
