...
impl SerializationStdlib {
    ...
    pub fn generate_from_json_code<T: for<'de> Deserialize<'de>>(json: &str, type_name: &str) -> String {
    ...
    pub fn generate_from_yaml_code<T: for<'de> Deserialize<'de>>(yaml: &str, type_name: &str) -> String {
    ...
    pub fn generate_deserialize_code<T: for<'de> Deserialize<'de>>(data: &str, type_name: &str) -> String {
